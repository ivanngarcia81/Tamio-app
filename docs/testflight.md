...
| **ninguna preparada** | **La 1.3.5 no existe todavía, y es lo correcto.** Desde el bump a la 1.3.4 (`dbc7178`) no ha entrado ni un commit, y ni sagan ni la rama del móvil traen nada nuevo. **Segunda vez que el número NO va por delante del trabajo** — la primera fue la 1.3.1. El número sube cuando haya algo que enseñar |
