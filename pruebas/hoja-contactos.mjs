...
const GRUPOS = [
  ...
  ["Las que se abren tocando algo", [
    ["30-t2-nuevo-ingreso", "T2 · nuevo ingreso"],
    ["30-t4-movimiento", "T4 · movimiento abierto"],
    ["30-t6-nuevo-deposito", "T6 · nuevo depósito"],
    ["30-t6-corte", "T6 · el corte"],
    ["30-t6-corte-pie", "T6 · corte, el pie"],
    ["30-a5-actividad", "A5 · la actividad"],
    ["30-a6-nueva-actividad", "A6 · nueva actividad"],
    ["30-n4-nuevo-miembro", "N4 · nuevo miembro"],
    ["30-n3-ficha-datos", "N3 · ficha · datos"],
    ["30-n3-ficha-membresia", "N3 · ficha · membresía"],
    ["30-n3-ficha-servicio", "N3 · ficha · servicio"],
  ]],
  ["Secretaría · resto", [
    ["16-actas", "Actas"],
