export const es = {
  ...
  depositos: {
    ...
    dobleFirmaDecision: "Este corte deja constancia de a quién se le entregó; quien recibe no confirma nada en la app. Fue una decisión, no un pendiente.",
  ...
  controlesTesoreria: {
    ...
    dobleFirmaSub: "Se eligió dejar constancia de a quién se entregó, no pedirle que lo confirme",
