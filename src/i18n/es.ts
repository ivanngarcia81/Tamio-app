export const es = {
  ...
  controlesTesoreria: {
    ...
    hint: "Los dos primeros ya funcionan, pero todavía no se pueden cambiar desde aquí: avisan en Por revisar y no bloquean el registro. Los otros dos son sitio reservado — el cierre de mes va por mes natural, que es como se cierran los libros de una iglesia.",
    comprobante: "Avisar de gastos sin comprobante desde {{monto}}",
    comprobanteSub: "Aparece en Por revisar; el importe todavía no se puede cambiar",
    ...
    dobleFirmaSub: "Todavía no existe quién firma un corte",
