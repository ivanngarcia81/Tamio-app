export const es = {
  ...
  detalleMiembro: {
    ...
    familiaTitulo: "Todavía no hay parentescos",
    familiaSub: "El padrón guarda a cada persona por separado: no hay forma de decir quién es cónyuge, hijo o hermano de quién. Cuando exista, esta pestaña enseñará el núcleo familiar y sus aportes juntos.",
    activo: "Activo",
    inactivo: "Inactivo",
