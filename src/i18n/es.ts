export const es = {
  ...
  depositos: {
    ...
    compartir: "Compartir",
    compartirAyuda: "Todavía no hay una hoja de compartir en Tamio. El botón está en su sitio para cuando la haya; mientras tanto, la ficha del banco se abre con \"Ver en grande\" y se puede compartir desde ahí.",
